...
const AppointmentTab = ({ t }) => (
  <div className="space-y-8">
    ...
    <div className=" rounded-2xl p-6 md:p-8 border border-brand4">
      <div className="flex items-center gap-3 mb-6">
        <div className="bg-brand3 p-3 rounded-xl">
          <FaFileAlt className="text-white text-2xl" />
        </div>
        <h3 className="text-2xl font-bold text-brand1">Что взять с собой</h3>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-4 items-start bg-white p-4 rounded-xl shadow-sm">
          ...
          <div>
            ...
            <p className="text-gray-600">
              При наличии — Цитологичекие и гистологические стекла и парафиновые
              блоки{" "}
            </p>
          </div>
        </div>
      ...
      <div className="mt-6 bg-brand1/10 p-4 rounded-xl border-l-4 border-brand1">
        <p className="text-gray-700 leading-relaxed">
          ...
          внимательно изучит документы, проведёт осмотр и предложит оптимальный
          план дальнейших действий — будь то дообследование, лечение или
          госпитализация.
        </p>
      </div>
    </div>
    ...
    <div className=" rounded-2xl p-6 md:p-8 border border-brand4">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className="text-2xl font-bold text-brand1">Как можно записаться</h3>
      </div>

      <p className="text-gray-700 mb-6 font-medium">Выберите удобный способ:</p>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
          ...
          <h4 className="font-bold text-lg text-brand1 mb-3">По телефону</h4>
          <p className="text-gray-600 mb-3">Позвоните нам по номеру</p>
          <a
            href="tel:+74996853000"
            className="text-brand3 font-bold text-xl hover:text-brand1 transition-colors"
          >
            +7 (499) 685 3000
          </a>
        ...
        <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
          ...
          <h4 className="font-bold text-lg text-brand1 mb-3">В регистратуре</h4>
          <p className="text-gray-600 mb-3">Мы открыты ежедневно</p>
          <p className="text-brand3 font-bold text-xl mb-3">8:00 до 23:00</p>
        ...
        <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
          ...
          <h4 className="font-bold text-lg text-brand1 mb-3">Через сайт</h4>
          <p className="text-gray-600 mb-3">
            Оставьте заявку в форме обратной связи, и мы свяжемся с вами.
          </p>
      ...
      <div className="space-y-4 text-gray-700">
        ...
        <div className="bg-white p-4 rounded-xl border-l-4 border-brand1">
          <p className="text-gray-700">
            <span className="font-semibold">⏰ Важно:</span> При опоздании более
            чем на 15 минут приём может быть перенесён, чтобы другие пациенты не
            ждали.
          </p>
        </div>
      </div>
    ...
    <div className="bg-gradient-to-r from-brand1 to-brand3 rounded-2xl p-6 md:p-8 text-white">
      <div className="flex items-start gap-4">
        ...
        <div>
          <h4 className="text-xl font-bold mb-2">Мы принимаем пациентов</h4>
          <p className="text-white/90 leading-relaxed">
            На платной основе и по программам ДМС. Будем рады помочь вам
            получить точный диагноз и современное лечение в комфортных условиях.
          </p>
        </div>
      </div>
    </div>
