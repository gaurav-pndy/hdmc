    ...
    <div className="bg-white py-12 overflow-hidden">
      ...
      >
        ...
        {allLogos.concat(allLogos).map((logo, i) => (
          <div
            key={i}
            className="flex justify-center items-center flex-shrink-0 w-[150px] sm:w-[180px] md:w-[200px] lg:w-[220px] px-6"
          >
            <a
              href={logo.url}
              target="_blank"
            ...
            >
              <img
                src={logo.src}
                alt={logo.alt}
                className="h-20 w-auto object-contain filter grayscale hover:grayscale-0 opacity-80 hover:opacity-100 transition-all duration-300"
              />
            </a>
          </div>
        ))}
