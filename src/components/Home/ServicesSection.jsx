      ...
      <div className="max-w-[87rem] text-center mx-auto px-4">
        ...
        <div className="grid mt-10 md:mt-14 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-10">
          {services.map((service, index) => (
            ...
            >
              <div className="w-16 h-16 rounded-full from-[#c668a9] to-[#af6ca5] flex items-center justify-center shrink-0 group-hover:rotate-15 bg-gradient-to-br group-hover:from-brand2 group-hover:to-brand1 transition-all duration-300 group-hover:scale-110">
                <img
                  src={service.image}
                  alt={t(service.title)}
