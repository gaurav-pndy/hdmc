      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-[#63cacc]/20 shadow-sm p-6 hover:border-[#63cacc]/40 transition-colors">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div className="font-bold text-lg text-[#125e84]">
          ...
          <div className="space-y-2 mb-4">
            <div className="flex flex-col text-[#125e84]/80 text-sm">
              <span className="text-[#125e84]/60 text-xs uppercase tracking-wide mb-1">
                {t("about.licenses.number")}
              </span>
              <span className="font-semibold text-[#125e84]">
            ...
            <div className="flex flex-col text-[#125e84]/80 text-sm">
              ...
              <span className="font-semibold text-[#125e84]">15.01.2020</span>
            </div>
          ...
          <div className="text-[#125e84]/70 text-xs leading-relaxed pt-3 border-t border-[#63cacc]/10">
        ...
        <div className="bg-white rounded-2xl border border-[#63cacc]/20 shadow-sm p-6 hover:border-[#63cacc]/40 transition-colors">
          ...
          <div className="space-y-2 mb-4">
            ...
            <div className="flex flex-col text-[#125e84]/80 text-sm">
              ...
              <span className="font-semibold text-[#125e84]">20.03.2021</span>
            </div>
            ...
            <div className="flex flex-col text-[#125e84]/80 text-sm">
              ...
              <span className="font-semibold text-[#125e84]">20.03.2026</span>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-[#63cacc]/20 shadow-sm p-6 hover:border-[#63cacc]/40 transition-colors">
          ...
          <div className="space-y-2 mb-4">
            ...
            <div className="flex flex-col text-[#125e84]/80 text-sm">
              ...
              <span className="font-semibold text-[#125e84]">Высшая</span>
            </div>
            ...
            <div className="flex flex-col text-[#125e84]/80 text-sm">
              ...
              <span className="font-semibold text-[#125e84]">15.12.2027</span>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-[#63cacc]/20 shadow-sm p-6 hover:border-[#63cacc]/40 transition-colors">
          ...
          <div className="space-y-2 mb-4">
            ...
            <div className="flex flex-col text-[#125e84]/80 text-sm">
              ...
              <span className="font-semibold text-[#125e84]">10.06.2023</span>
            </div>
            ...
            <div className="flex flex-col text-[#125e84]/80 text-sm">
              ...
              <span className="font-semibold text-[#125e84]">10.06.2026</span>
            </div>
          </div>
