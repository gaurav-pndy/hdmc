...
const AboutDiseases = () => {
  ...
  return (
    <div
      ...
      style={{
        background: `linear-gradient(to right, blue20, yellow20)`,
      }}
    >
      <div className="mb-4 max-w-[87rem] mx-auto text-brand1 flex gap-2 font-semibold items-center">
        ...
        Все про питание во время онкологического лечения. Часть 2.
      </div>
      {/* HERO */}
          ...
          <div className="relative w-full  h-full">
            ...
            <div
              ...
              style={{
                background: `linear-gradient(${
                  isMobile ? "to bottom" : "to right"
                }, blue, yellow66 30%, transparent 100%)`,
              }}
            ></div>
          </div>
        </div>
      ...
      <div className="max-w-[87rem] mx-auto  mt-10">
        ...
        <div
          ...
          //   dangerouslySetInnerHTML={{ __html: t("news.newsList.news1.text") }}
        ></div>
      </div>
    </div>
  );
